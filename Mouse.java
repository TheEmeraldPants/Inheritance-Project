...
public class Mouse extends Peripheral {
    ...
    public Mouse(double price, String brand, boolean rgb, int pCon, String name, String desc, double weight, double[] dimensions, String ioPort, int dpi, int extraButtons) {
        super(price, brand, rgb, pCon, name, desc, weight, dimensions, ioPort);
        DPI = dpi;
